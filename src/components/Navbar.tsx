      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between gap-4 lg:gap-8">
        ...
        <div className="flex-1 max-w-3xl relative hidden md:block group">
          <div className="relative flex items-center w-full h-12 rounded-full shadow-sm focus-within:shadow-lg focus-within:shadow-brand-orange/20 bg-gray-50 dark:bg-gray-900 border-2 border-brand-orange/30 focus-within:border-brand-orange transition-all overflow-hidden">
            ...
            />
            <button className="h-full px-8 bg-brand-orange hover:bg-orange-600 text-white font-bold transition-colors">
              Search
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 md:gap-5">
          ...
          <button className="w-10 h-10 rounded-full bg-orange-50 dark:bg-orange-900/20 flex items-center justify-center text-brand-orange transition-all relative shadow-sm border border-brand-orange/20 hover:bg-brand-orange hover:text-white" aria-label="Cart">
          ...
          <button className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 hidden sm:flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-brand-orange dark:hover:text-brand-orange hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all" aria-label="Account">
            <User size={20} />
          </button>
        </div>
      </div>
